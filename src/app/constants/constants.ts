...
export const TOP_DROPDOWNS: TTopDropdown[] = [
	{
		...
		type: "vertical",
		items: [
			{ label: "Bienvenida", href: "/nosotros" },
			{ label: "Organigrama", href: "/organigrama" },
			{ label: "Directorio", href: "/directorio" },
			{ label: "Jurisdicción", href: "/jurisdiccion" },
			{ label: "Instituciones Educativas", href: "/instituciones-educativas" },
			{ label: "Visión Misión", href: "/vision-mision" },
