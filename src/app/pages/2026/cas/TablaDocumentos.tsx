    ...
    <div className="group relative flex flex-col bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
      ...
      <div className="p-6 flex flex-col h-full">
        ...
        <div className="grid grid-cols-2 gap-2 mb-6">
          ...
          {doc.perfiles && (() => { const d = getLinkData(doc.perfiles); return d && <BotonDescarga href={d.url} label="Perfiles" fecha={d.fecha} /> })()}
          ...
          {doc.comunicado4 && (() => { const d = getLinkData(doc.comunicado4); return d && <BotonDescarga href={d.url} label="Comunicado N°04" fecha={d.fecha} fullWidth /> })()}
        </div>
      </div>
