...
export const DOCUMENTOS_NORMATIVOS: TDocumentoNormativo[] = [
{
    ...
    archivoUrl: [
      {
        label: "Convocatoria",
        url: "/assets/files/2026/contrata-docente/79.COMUNICADO-A-PROPUESTA-DEL-DIRECTOR-IE-22-05-2026.pdf",
        fecha: "2026-05-22",
      },
...
{
    numero: "75",
    nombre: "Resultado Final de Convocatoria a Presentación de Expedientes Modalidad PANETS (Matemática)",
    tipo: "Resultado",
    fecha: "2026-05-15",
    badge: { label: "Nuevo", color: "#10b981" },
    archivoUrl: [
      {
        label: "Resultado",
        url: "/assets/files/2026/contrata-docente/75.CALIFICACION-DE-EXPEDIENTES-PANETS-MATEMATICA-F-15052026.pdf",
        fecha: "2026-05-15",
      },
...
{
    numero: "74",
    nombre: "FeErratas Ampliación de Convocatoria a Presentación de Expedientes Modalidad PANETS",
    tipo: "Convocatoria",
    fecha: "2026-05-14",
    badge: { label: "Nuevo", color: "#10b981" },
    archivoUrl: [
...

{
    ...
    archivoUrl: [
      {
        label: "Convocatoria",
        url: "/assets/files/2026/contrata-docente/72.AMPLIACION-CONVOCATORIA-PANETS-F-13052026.pdf",
        fecha: "2026-05-13",
      },
...
{
    numero: "71",
    nombre: "Resultado Final Evaluación de Expedientes Modalidad PANETS",
    tipo: "Resultado",
    fecha: "2026-05-12",
    badge: { label: "Nuevo", color: "#10b981" },
    archivoUrl: [
...

{
    ...
    archivoUrl: [
      {
        label: "Convocatoria",
        url: "/assets/files/2026/contrata-docente/69.CONVOCATORIA-PANETS-F-08052026.pdf",
        fecha: "2026-05-08",
      },
...

{
    ...
    archivoUrl: [
      {
        label: "Convocatoria",
        url: "/assets/files/2026/contrata-docente/67.CANCELACION-DE-CONVOCATORIA-EBA-F-08052026.pdf",
        fecha: "2026-05-08",
      },
...

{
    ...
    archivoUrl: [
      {
        label: "Resultados",
        url: "/assets/files/2026/contrata-docente/63.RESULTADOS-PRELIMINARES-CONVOCATORIA.CYT-F-05052026.pdf",
        fecha: "2026-05-05",
      },
...

{
    ...
    archivoUrl: [
      {
        label: "Convocatoria",
        url: "/assets/files/2026/contrata-docente/61.CONVOCATORIA-CIENCIA-Y-TECNOLOGIA-F-04052026.pdf",
        fecha: "2026-05-04",
      },
...

{
    ...
    archivoUrl: [
      {
        label: "Convocatoria",
        url: "/assets/files/2026/contrata-docente/55.RESULTADO-FINAL-EBR.MATEMATICA-F-24042026.pdf",
        fecha: "2026-04-24",
      },  
    ],
},
...

{
    ...
    archivoUrl: [
      {
        label: "Convocatoria",
        url: "/assets/files/2026/contrata-docente/53.COMUNICADO-DE-ADJUDICACION-22042026.pdf",
        fecha: "2026-04-22",
      },
      {
        label: "Plazas",
        url: "/assets/files/2026/contrata-docente/53.PLAZA_ED.-FISICA-F-22042026.pdf",
        fecha: "2026-04-22",
      }, 
    ],
},
...
{
    numero: "52",
    nombre: "Ampliacición de cronograma a presentación de expedientes: Arte y Cultura",
    tipo: "Convocatoria",
    fecha: "2026-04-22",
    badge: { label: "Nuevo", color: "#10b981" },
    archivoUrl: [
      {
        label: "Convocatoria",
        url: "/assets/files/2026/contrata-docente/52.AMPLIACION-DE-CRONOGRAMA-EBR.ARTE-Y-CULTURA-F-22042026.pdf",
        fecha: "2026-04-22",
      },  
    ],
},
