...
const TablaDocumentos = () => {
    return <DataTable columns={columns} data={DOCUMENTOS_NORMATIVOS} title="Documentos Encargaturas - UGEL La Convención" defaultSortFieldId="numero" defaultSortAsc={false} />
}
