...
export const DOCUMENTOS_NORMATIVOS: TDocumentoNormativo[] = [
	...
	{
		numero: "05",
		nombre: "Comunicado, Link Inscripción - Contratación Docente 2026 II.EE DEL MODELO DE SERVICIO EDUCATIVO DE SECUNDARIA EN ALTERNANCIA (CRFA)",
		tipo: "Comunicado N°04",
		fecha: "2026-03-02",
	...
	},
	{
		...
		tipo: "Comunicado N°03",
		fecha: "2026-02-16",
		archivoUrl: "/assets/files/2026/contratacion-docente-crfa/04.COMUNICADO.N03-RESULTADO-ENTREVISTA-PN-F-16022026.pdf",
	},
	{
		numero: "03",
		nombre: "Comunicado, Entrevista a Docentes de la PN CRFA 2026 II.EE DEL MODELO DE SERVICIO EDUCATIVO DE SECUNDARIA EN ALTERNANCIA (CRFA)",
		tipo: "Comunicado N°02",
		fecha: "2026-02-10",
