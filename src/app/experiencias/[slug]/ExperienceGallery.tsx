...
export default function ExperienceGallery({ experience }: { experience: TExperience }) {
	const lightGalleryRef = useRef<LightGalleryType | null>(null)
	const galleryUrls = useMemo(() => [experience.coverUrl!, ...(experience.galleryUrls || [])], [experience.coverUrl, experience.galleryUrls])

	useEffect(() => {
		const galleryContainer = document.getElementById("experience-gallery")
	...
	return (
		<section className="py-16 lg:py-24">
			<div className="container">
				...
				<div id="experience-gallery" className="grid grid-cols-2 md:grid-cols-3 gap-4">
