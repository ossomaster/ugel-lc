...
const DEFAULT_IMAGE = asset("/assets/images/contracion-auxiliares-2026.jpg")
const DEFAULT_COLOR = "var(--color-primary)"

interface PageHeroContratacionAuxiliarProps {
	title: string
	subtitle?: string
	image?: string
	color?: string
...
export default function PageHeroContratacionAuxiliar({ title, subtitle, image = DEFAULT_IMAGE, color = DEFAULT_COLOR }: PageHeroContratacionAuxiliarProps) {
	return (
		<section
