...
const DEFAULT_IMAGE = asset("/assets/images/fondo-cifras-ugellc.jpg")
const DEFAULT_COLOR = "var(--color-primary)"

interface PageImageTopProps {
	title: string
	subtitle?: string
	image?: string
	color?: string
...
export default function PageImageTop({ title, subtitle, image = DEFAULT_IMAGE, color = DEFAULT_COLOR }: PageImageTopProps) {
	return (
		<section
