...
const DEFAULT_IMAGE = asset("/assets/images/contratacion-docente-2026.jpg")
const DEFAULT_COLOR = "var(--color-primary)"

interface PageHeroContratacionDocenteProps {
	title: string
	subtitle?: string
	image?: string
	color?: string
...
export default function PageHeroContratacionDocente({ title, subtitle, image = DEFAULT_IMAGE, color = DEFAULT_COLOR }: PageHeroContratacionDocenteProps) {
	return (
		<section
